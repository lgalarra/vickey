...
public class ConditionalKeysMiner {
	...
	public ConditionalKeysMiner(KB kb) {
		this.kb = kb;
	...
	/**
	 * It builds a rule of the form r(?a, ?l) r(?b, ?l') ... c(?a, C), c(?b, C') ... => equals(a, b)
	 ...
	 * @return
	 */
	private List<String> buildList(List<String> nk, int[] indexes) {
